...
military = {
	...
	SIEGE_BRIGADES_MIN = 8, -- the number of brigades needed for a siege to progress at normal speed
	...
	RECON_SIEGE_EFFECT = 300, -- multiplier to effect of recon on speeding up sieges
